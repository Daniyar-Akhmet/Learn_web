from flask import abort, Blueprint, current_app, flash, redirect, request, render_template, url_for 
# current_app позволяет обращатся к текущему flask приложению
